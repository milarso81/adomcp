...
public class PullRequestToolTests
{
    ...
    public async Task ListPullRequests_ReturnsJsonList_WhenPullRequestsExist()
    {
        // Arrange
    ...
    public async Task ListPullRequests_ReturnsEmptyArray_WhenNoneExist()
    {
        var mockService = new Mock<IAdoPullRequestService>();
        var mockConfig = new Mock<IConfiguration>();
        mockConfig.Setup(c => c["Ado:Organization"]).Returns("org");
    ...
    [Fact]
    public async Task ListPullRequests_Throws_WhenConfigMissing()
    {
        var mockService = new Mock<IAdoPullRequestService>();
        var mockConfig = new Mock<IConfiguration>();
